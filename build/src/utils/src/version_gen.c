...
const char * V_SLOCAL_REVISION="44";
const char * V_SREVISION="889ff485908a";
const char * V_STAG="2023.02 +44";
...
const uint32_t V_REVISION_0=0x889ff485;
const uint16_t V_REVISION_1=0x908a;
